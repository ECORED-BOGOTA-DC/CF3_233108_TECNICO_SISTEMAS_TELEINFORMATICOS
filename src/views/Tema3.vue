...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .tarjeta.tarjeta--blanca.p-4
        SlyderA(tipo="b")
          .row.justify-content-around
            ...
            .col-lg-4
              .h4.t-p.mb-3 ¿Dónde está ubicada la computadora?
          ...
          .row.justify-content-around
            ...
            .col-lg-4
              .h4.t-p.mb-3 Entorno informático
              .h4 NO:
              ul.lista-ul--color.lista-ul--separador
                li(style="margin-bottom: 2px")
                  i.fas.fa-check-circle.t-ac
    ...
    .BGM03.px-md-5.px-4.pb-4.mb-5 
      .row.justify-content-center.mb-5
        .col-auto.BGS05.px-4.py-2(data-aos="fade-left")
          .h4.text-white.text-center.mb-0 Tener en cuenta
    ...
    .BGIMG06.px-md-5.px-4.pb-4.mb-5 
      ...
      .row.justify-content-center
        .col-lg-10
          ...
          .BGB04.row.mb-2(data-aos="fade-right")
            .col-2.BG01.p-lg-4.p-2
              p.text-center.mb-0(style="font-weight: 900; font-size: 30px !important") 06
            .col
              .p-4
    ...
    .row.justify-content-center.mb-5
      .col-lg-6.mb-lg-0.mb-4         
        .BG05
          ...
          .p-4
            p.text-white.text-center.mb-0 Asegúrese de que la bandeja se seque por completo después de limpiarla antes de volver a colocarla en la unidad.
      .col-lg-6.mb-lg-0.mb-4
        .BG01
          .row.align-items-end
            .col-12
        ...
        .col-lg-8(data-aos="fade-left")
          SlyderF.mb-5(columnas="col-lg-6")
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Los CD sucios pueden causar errores de lectura o hacer que los CD no funcionen en absoluto.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Utilice un kit de limpieza o un paño de algodón limpio y húmedo para limpiar los CD, DVD y otros discos.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Cuando limpie un disco, frote contra las pistas, comenzando desde la mitad del disco y limpiando hacia el lado exterior.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Nunca limpie con las huellas; si lo hace, podría rayar más el disco.
    ...
    .BGIMG03.px-md-5.px-4.mb-5
      .row.justify-content-center.align-items-center
        .col-lg-8.order-lg-1.order-2(data-aos="fade-right")
          SlyderF.mb-5(columnas="col-lg-6")
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Después de eliminar el polvo, la suciedad y el cabello.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Rocíe un desinfectante en un paño o use paños desinfectantes y frote cada una de las teclas del teclado.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Como se menciona en nuestros consejos generales de limpieza, nunca rocíe ningún líquido sobre el teclado.
    ...
    .BGIMG03.px-md-5.px-4.mb-5
      .row.justify-content-center.align-items-center
        ...
        .col-lg-8(data-aos="fade-left")
          SlyderF.mb-5(columnas="col-lg-6")
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Nuestra recomendación a la hora de limpiar la placa base de polvo, suciedad o pelos es utilizar aire comprimido.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Cuando utilice aire comprimido, manténgalo en posición vertical para evitar que los productos químicos salgan del recipiente, lo que podría dañar la placa base u otros componentes.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Además, cuando utilice aire comprimido, asegúrese de quitar siempre el polvo o la suciedad de la placa base o de la carcasa.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Otra buena alternativa al aire comprimido es una aspiradora portátil a batería.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Las aspiradoras portátiles pueden eliminar por completo el polvo, la suciedad y el cabello de la placa base y evitar que quede atrapado en la carcasa.
    ...
    .row.justify-content-center.mb-5
      .col-auto.BGS05.px-4.py-2(data-aos="fade-left")
        .h4.text-white.text-center.mb-0 Hay dos formas de limpiar la tarjeta gráfica
      ...
      .row.justify-content-center
        .col-auto.img-02
          .tarjeta.BGS05.px-5.py-2
            .h5.text-white.text-center.mb-0 Ahora, se conocerá más al respecto sobre estos
    ...
    .BGIMG03.px-md-5.px-4.mb-5
      .row.justify-content-center.align-items-center
        ...
        .col-lg-8(data-aos="fade-left")
          SlyderF.mb-5(columnas="col-lg-6")
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Al hacer sus propios productos de limpieza para los equipos, puede ahorrar dinero y controlar la cantidad de productos químicos peligrosos.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Sin embargo, primero debe tener en cuenta algunas de las limitaciones o inconvenientes de los productos caseros.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Los caseros pueden tardar más en limpiarse de manera efectiva.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Es posible que deba dejar que el producto “se asiente” en la superficie durante más tiempo de lo habitual o que deba repasar la superficie varias veces.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Es posible que se requiera más esfuerzo y es posible que el producto no limpie tan bien si se usó repetidamente un limpiador fuerte en la superficie antes de la solución casera.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Si decide hacer sus propios limpiadores, úselos y guárdelos de manera segura.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Si bien los ingredientes de los limpiadores caseros son más seguros, no todos son tóxicos.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Tenga cuidado al mezclar productos químicos.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Algunas sustancias químicas, como la lejía con cloro y el amoníaco, producen un gas tóxico cuando se mezclan.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 No mezcle más de un mes de suministro a la vez. Las soluciones químicas pueden perder su eficacia con el tiempo.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Mezcle las soluciones en un área bien ventilada. Guarde todas las soluciones de limpieza fuera del alcance de los niños, preferiblemente en un gabinete con cerradura a prueba de niños.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Almacene las soluciones en recipientes comprados en tiendas sin usar.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Utilice contenedores de almacenamiento permanente que se colocarán en un lugar permanente.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Nunca los ponga en recipientes de comida viejos.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Los productos químicos pueden interactuar con los residuos del contenido original o el recipiente puede confundirse con un alimento o una bebida.
            .tarjeta.color-secundario.p-4.h-100
              p.text-center.text-white.mb-0 Etiquete los contenedores con cuidado. Esto es especialmente importante si otras personas en su hogar limpian o tienen acceso a los limpiadores.
